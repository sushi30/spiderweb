...
```cmd
docker run --name sw-airflow ^
-v "C:\Users\imri\github\spiderweb\data-pipeline\airflow-requirements.txt":/usr/local/airflow/requirements.txt ^
-v "C:\Users\imri\github\spiderweb\data-pipeline\dags":/usr/local/airflow/dags ^
-v "C:\Users\imri\github\spiderweb\data-pipeline\out":/usr/local/airflow/artifacts ^
